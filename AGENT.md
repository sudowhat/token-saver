...
Token Saver is an **optimization layer** for an existing software project. It does not replace the target project's own agent protocol, architecture, build rules, tests, or Git workflow.
